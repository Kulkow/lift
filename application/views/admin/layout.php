...
<body>
		...
		<nav id="menu">
			<?php if (Auth::instance()->logged_in()) : ?>
				<ul>
                    ...
                    <li<?php if ($menu == 'house') echo ' class="current"' ?>>
						<a href="/admin/house">Дома</a>
					</li>
                    <li<?php if ($menu == 'lift') echo ' class="current"' ?>>
						<a href="/admin/lift">Лифты</a>
					</li>
	...
	<footer id="footer">
        <ul>
        	...
        	<li>&copy; 2013-<?php echo date('Y') ?></li>
